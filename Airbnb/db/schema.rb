...
ActiveRecord::Schema.define(version: 2019_08_03_064757) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.index ["dog_id"], name: "index_cities_on_dog_id"
    t.index ["dogsitter_id"], name: "index_cities_on_dogsitter_id"
  end
